...
exports.server = {
    ...
    measures: {
        ...
        egtotal                     : 'Effekt Gesamt Attribution (Geometrisch) ([CUR])',
        egtotalc                    : 'Effekt Gesamt Währung (Geometrisch) ([CUR])',
        egtotallocal                : 'Effekt Gesamt Markt (Geometrisch) (Local)',
        egtotalmca                  : 'Effekt Gesamt Attribution (Geometrisch) ([CUR])',
        einter                      : 'Effekt Interaktion',
        einterlocal                 : 'Effekt Interaktion (Lokal)',
        eselec                      : 'Effekt Selektion',
        eselecinter                 : 'Effekt Selektion (Incl. Interaktion)',
        eselecinterlocal            : 'Effekt Selektion (Incl. Interaktion) (Lokal)',
        eseleclocal                 : 'Effekt Selektion (Lokal)',
        etimingc                    : 'Effekt Currency Timing ([CUR])',

    ...
    function render(chartsToRender, renderTo) {
        ...
        for (var i = 0; i < chartsToRender.length; i++) {
            ...
            if (!chart) {
                ...
                isTable = (chartsDataObject.get(chartsToRender[i].chartId).chartType !== 'Table');
                containerClass = isTable ? 'chartContainer' : '';
                ...
                $(renderTo).append(
                    $(
                        ...
                        '       <div id="' + chartsToRender[i].chartId + '" class="' + containerClass + '"></div>' +
                        '   </div>' +
                        '</div>'
                    ));
            }
